...
export default function Login3() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100 font-sans">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-12 lg:p-16 xl:p-24 relative">
        ...
        <div className="relative z-10 flex flex-col justify-end p-16 h-full w-full max-w-2xl">
            ...
            <div className="backdrop-blur-md bg-white/10 border border-white/20 p-8 rounded-2xl shadow-2xl">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-green-400 text-sm font-semibold tracking-wide uppercase">Verified System</span>
                </div>
                <h2 className="text-3xl font-bold text-white mb-4 leading-tight">
                    "The most robust and secure platform for scaling your business globally."
                </h2>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 text-sm">CTO at TechGlobal</p>
                    </div>
                </div>
            </div>
